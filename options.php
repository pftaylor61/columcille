...
function optionsframework_options() {
	...
	$options[] = array(
        ...
        $options[] = array(
		'name' => esc_html__( 'Special Settings', 'qohelet' ),
		'type' => 'heading' );
        
        $options[] = array(
		'name' => esc_html__( 'Homepage Panel Settings', 'qohelet' ),
		'desc' => esc_html__( 'In the boxes below, you should write the post ID number of the three pages that you want to display in the homepage special panels. The ID numbers can be found by hovering over the page entry here in the dashboard.', 'qohelet' ),
		'type' => 'info' );
        
        $options[] = array(
		'name' => esc_html__( 'Panel 1', 'qohelet' ),
		'desc' => esc_html__( 'Enter the page ID number.', 'qohelet' ),
		'id' => 'hp_p1',
		'std' => '',
		'type' => 'text' );
        
        $options[] = array(
		'name' => esc_html__( 'Panel 2', 'qohelet' ),
		'desc' => esc_html__( 'Enter the page ID number.', 'qohelet' ),
		'id' => 'hp_p2',
		'std' => '',
		'type' => 'text' );
        ...
        $options[] = array(
		'name' => esc_html__( 'Panel 3', 'qohelet' ),
		'desc' => esc_html__( 'Enter the page ID number.', 'qohelet' ),
		'id' => 'hp_p3',
		'std' => '',
		'type' => 'text' );
